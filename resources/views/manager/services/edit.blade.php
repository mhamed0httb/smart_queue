        ...
        <div class="col-md-12">
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Edit Service : {{ $service->name }}</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                ...
                {{ Form::model($service, array('route' => array('services.update', $service->id), 'method' => 'PUT', 'class' => 'form-horizontal')) }}
                <div class="box-body">
                    <div class="form-group">
                        {{ Form::label('service_name', 'Service Name', array('class' => 'col-sm-2 control-label', 'for' => 'name')) }}

                        <div class="col-sm-10">
                            {{ Form::text('name', null, array('class' => 'form-control','value' => $service->name,'placeholder' => 'name', 'name' => 'name', 'id' => 'name', 'required' => 'true')) }}
                        </div>
                    </div>
                    <div class="form-group">
                        {{ Form::label('category', 'Category', array('class' => 'col-sm-2 control-label', 'for' => 'category_id')) }}
