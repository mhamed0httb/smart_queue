...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{url('/dashboard/adCompanies')}}">{{ $sub_page_title or 'Ad Companies' }}</a></li>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-info">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                {{ Form::model($company, array('route' => array('adCompanies.update', $company->id), 'method' => 'PUT', 'class' => 'form-horizontal')) }}
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" value="{{ $company->service_category }}" name="category" class="form-control" id="category" placeholder="category" required>
                        </div>
                    </div>
                    <div class="form-group">
